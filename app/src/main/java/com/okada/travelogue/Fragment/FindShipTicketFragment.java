...
public class FindShipTicketFragment extends Fragment {
    private LinearLayout layout;
    private TextView textView,findShipTravelWithUs;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_find_ship_ticket, container, false);
    }
    ...
    private void checkLanguage() {
        ...
        findShipTravelWithUs.setText(resources.getString(R.string.travel_with_us));
    ...
    private void initialization(View view) {
        layout = view.findViewById(R.id.find_ship_ticket_date_layout);
        textView = view.findViewById(R.id.find_ship_ticket_date_text);
        ...
        searchButton=view.findViewById(R.id.ship_search_button);
        findShipTravelWithUs=view.findViewById(R.id.find_ship_travel_with_us);
