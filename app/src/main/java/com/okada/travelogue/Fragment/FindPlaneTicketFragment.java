...
import com.okada.travelogue.Adapters.SpinnerAdapter;
...
public class FindPlaneTicketFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_find_plane_ticket, container, false);
    }
    ...
    private void initialization(View view) {
        layout = view.findViewById(R.id.find_plane_ticket_date_layout);
        textView = view.findViewById(R.id.find_plane_ticket_date_text);
        ...
        searchButton=view.findViewById(R.id.plane_search_button);
            ...
            public void onClick(View v) {
                ...
                if (hasError){
                    ...
                    if (getActivity()!=null){
                        ...
                        intent.putExtra("vehicle","plane");
                        int count=searchableSpinnerPassenger.getSelectedIndex()+1;
